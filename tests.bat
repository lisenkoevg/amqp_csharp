...
:: testSend purgeQueue timestamp "{'user_hash': '%user_hash%'}"
...
testSend delivery_prognosis "{'user_hash': '%user_hash%', 'item_id': '203866'}"
...
testSend multiplicate_values "{'user_hash': '%user_hash%'}"
